...
class Enemy(pygame.sprite.Sprite):
    ...
    def animation(self):
        down = [self.game.enemy_spritesheet.get_image(0, 0, self.width, self.height),
        ...
        left = [self.game.enemy_spritesheet.get_image(0, 32, self.width, self.height),
        ...
        right = [self.game.enemy_spritesheet.get_image(0, 64, self.width, self.height),
        ...
        up = [self.game.enemy_spritesheet.get_image(0, 96, self.width, self.height),
