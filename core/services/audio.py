...
class AudioService(Service):
    ...
    def sync_from_config(self):
        if not self._config:
            return
        self.music_volume = self._config.get_music_volume()
        self.menu_music_volume = self._config.get_menu_music_volume()
        self.dungeon_music_volume = self._config.get_dungeon_music_volume()
        self.sfx_volume = self._config.get_sfx_volume()
        if self.initialized:
    ...
    def adjust_sfx_volume(self, delta):
        ...
        if self._config:
            self._config.set_sfx_volume(new_volume)
        for sound in self.sounds.values():
    ...
    def adjust_music_volume(self, delta):
        ...
        if self._config:
            self._config.set_music_volume(new_volume)
    ...
    def set_menu_music_volume(self, volume):
        ...
        if self._config:
            self._config.set_menu_music_volume(self.menu_music_volume)
    ...
    def set_dungeon_music_volume(self, volume):
        ...
        if self._config:
            self._config.set_dungeon_music_volume(self.dungeon_music_volume)
