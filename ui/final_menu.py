...
class FinalMenu:
    ...
    def draw(self, surface):
        ...
        title_surf = self.game.services.font.render(
            self.game.services.font.t("final_menu.title"), 48, (200, 0, 0), shadow=BLACK
        )
        title_rect = title_surf.get_rect(center=(center_x, center_y - 100))
        surface.blit(title_surf, title_rect)

        message_surf = self.game.services.font.render(
            self.game.services.font.t("final_menu.message"), 24, (200, 200, 200), shadow=BLACK
        )
